    ...
    def _story_friendly_output(self, output):
        ...
        * Messages reporting package versions.
        ...
        friendly_output = "\n".join(
            [
                line.rstrip()
                for line in output.replace(colorama.Fore.RED, "")
                .replace(colorama.Fore.BLUE, "")
                .replace(colorama.Fore.GREEN, "")
                .replace(colorama.Style.BRIGHT, "")
                .replace(colorama.Style.DIM, "")
                .replace(colorama.Style.NORMAL, "")
                .replace(colorama.Fore.RESET, "")
                .replace(colorama.Style.RESET_ALL, "")
